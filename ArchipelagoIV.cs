    ...
    private Dictionary<string, long> GTAIVMission_table = new Dictionary<string, long>(StringComparer.InvariantCultureIgnoreCase)
        {
            ...
            { "It's Your Call", 810002 },
            { "Three's a Crowd", 810003 },
            { "First Date", 810004 },
            { "Bleed Out", 810005 },
            { "Easy Fare", 810006 },
            { "Jamaican Heat", 810007 },
            { "Bull in a China Shop", 810008 },
            { "Hung Out to Dry", 810009 },
            { "Clean Getaway", 810010 },
            { "Ivan the Not So Terrible", 810011 },
            { "Concrete Jungle", 810012 },
            { "Uncle Vlad", 810013 },
            { "Crime and Punishment", 810014 },
            { "Do You Have Protection?", 810015 },
            { "Shadow", 810016 },
            { "Final Destination", 810017 },
            { "No Love Lost", 810018 },
            { "Logging On", 810019 },
            { "Rigged to Blow", 810020 },
            { "Search and Delete", 810021 },
            { "Easy as Can Be", 810022 },
            { "The Master and the Molotov", 810023 },
            { "Russian Revolution", 810024 },
            { "Roman's Sorrow", 810025 },
            { "Out of the Closet", 810026 },
            { "No. 1", 810027 },
            { "Escuela of the Streets", 810028 },
            { "Street Sweeper", 810029 },
            { "Luck of the Irish", 810030 },
            { "Blow Your Cover", 810031 },
            { "The Puerto Rican Connection", 810032 },
            { "The Snow Storm", 810033 },
            { "Have a Heart", 810034 },
            { "Call and Collect", 810035 },
            { "Harboring a Grudge", 810036 },
            { "Waste Not Want Knots", 810037 },
            { "Three Leaf Clover", 810038 },
            { "Final Interview", 810039 },
            { "Holland Nights", 810040 },
            { "Lure", 810041 },
            { "Deconstruction for Beginners", 810042 },
            { "Photo Shoot", 810043 },
            { "Ruff Rider", 810044 },
            { "Undress to Kill", 810045 },
            { "Wrong is Right", 810046 },
            { "Portrait of a Killer", 810047 },
            { "Hostile Negotiation", 810048 },
            { "The Holland Play", 810049 },
            { "Dust Off", 810050 },
            { "Paper Trail", 810051 },
            { "Actions Speak Louder than Words", 810052 },
            { "I Need Your Clothes, Your Boots, and Your Motorcycle", 810053 },
            { "Smackdown", 810054 },
            { "A Long Way to Fall", 810055 },
            { "Babysitting", 810056 },
            { "Tunnel of Death", 810057 },
            { "Blood Brothers", 810058 },
            { "Undertaker", 810059 },
            { "Taking in the Trash", 810060 },
            { "Meltdown", 810061 },
            { "I'll Take Her", 810062 },
            { "Museum Piece", 810063 },
            { "No Way on the Subway", 810064 },
            { "Late Checkout", 810065 },
            { "Weekend at Florian's", 810066 },
            { "Ransom", 810067 },
            { "She's a Keeper", 810068 },
            { "Hating the Haters", 810069 },
            { "Union Drive", 810070 },
            { "Buoys Ahoy", 810071 },
            { "Truck Hustle", 810072 },
            { "Pegorino's Pride", 810073 },
            { "Payback", 810074 },
            { "Catch the Wave", 810075 },
            { "Trespass", 810076 },
            { "To Live and Die in Alderney", 810077 },
            { "Diamonds Are a Girl's Best Friend", 810078 },
            { "Entourage", 810079 },
            { "Dining Out", 810080 },
            { "Liquidize the Assets", 810081 },
            { "Flatline", 810082 },
            { "Pest Control", 810083 },
            { "That Special Someone", 810084 },
            { "One Last Thing", 810085 },

            // DEAL ENDING
            { "If the Price Is Right", 810086 },
            { "Mr. and Mrs. Bellic (Deal)", 810087 },
            { "A Revenger's Tragedy", 810088 },

            // REVENGE ENDING
            { "A Dish Served Cold", 810089 },
            { "Mr. and Mrs. Bellic (Revenge)", 810090 },
            { "Out of Commission", 810091 }
        };
